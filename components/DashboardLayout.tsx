...
export function DashboardLayout({ children, filters, systems, title = "Dashboard", description, showFilters = true }: Props) {
      ...
      <div className="flex">
        ...
        <main className="flex-1 flex flex-col min-h-screen">
          <header className="border-b border-slate-200 bg-white px-4 py-4 md:px-6 space-y-3 sticky top-0 z-20 backdrop-blur supports-[backdrop-filter]:bg-white/80">
            ...
            {showFilters ? <DashboardFilterBar filters={filters} systems={systems} /> : null}
          </header>
